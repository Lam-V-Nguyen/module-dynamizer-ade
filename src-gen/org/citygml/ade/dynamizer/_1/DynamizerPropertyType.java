...
/**
 * <p>Java-Klasse für DynamizerPropertyType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.citygml.org/ade/dynamizer_ade/1.0}Dynamizer"/>
 *       &lt;/sequence>
...
@XmlType(name = "DynamizerPropertyType", propOrder = {
    "dynamizer"
})
public class DynamizerPropertyType {

    @XmlElement(name = "Dynamizer")
    protected DynamizerType dynamizer;
    ...
    /**
     * Ruft den Wert der dynamizer-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link DynamizerType }
     *     
     */
    public DynamizerType getDynamizer() {
        return dynamizer;
    }

    /**
     * Legt den Wert der dynamizer-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link DynamizerType }
     *     
     */
    public void setDynamizer(DynamizerType value) {
        this.dynamizer = value;
    }

    public boolean isSetDynamizer() {
        return (this.dynamizer!= null);
    }
